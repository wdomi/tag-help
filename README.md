...
Change the data to match your animals:
...
⚠️ **You can delete unneeded columns but you cannot:**

- delete the first language column
- rename headers
- add new columns
...
If used on your android smartphone the tag-help.html should open automatically in a browser window.

For iPhone users it is necessary to download the app **Documents by Readdle** which allows you to override internal security constraints and open the html in a browser.

For easy access you can "export" or "share" and add to Homescreen.
